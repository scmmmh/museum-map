...
<div class="flex flex-col h-screen">
  <Header
    title={$currentFloor ? $currentFloor.attributes.label : "Loading..."}
    nav={[
      {
        label: $currentFloor ? $currentFloor.attributes.label : "Loading...",
