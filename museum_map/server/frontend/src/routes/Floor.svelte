...
<div class="flex flex-col h-screen">
    ...
    <div class="lg:hidden flex-none flex flex-row">
        ...
        <div class="flex-none mr-2 lg:mr-4 mt-2 lg:mt-4">
            <button on:click={() => { changeMode(MODE_LIST); }} class="inline-block bg-neutral-600 px-3 py-3 lg:py-3 rounded-lg lg:underline-offset-2 lg:hover:bg-blue-800 lg:focus:bg-blue-800 {mode === MODE_LIST ? 'bg-blue-800' : ''}" aria-label="Explore the museum in text form">
                <svg class="w-6 h-6" viewBox="0 0 24 24" aria-hidden="true">
